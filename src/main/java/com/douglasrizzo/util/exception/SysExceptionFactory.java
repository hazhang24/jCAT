...
import com.douglasrizzo.util.log.LoggerGenerator;
...
public class SysExceptionFactory
{
	public static DAOException getException(Exception exception)
	{
		...
		if (Environment.getLogTraceSystemOut())
		{
			...
			LoggerGenerator
					.write(LoggerGenerator.EVENT_ACESSO_BD, errorMessage);
		}

		if (Environment.getLogTraceFile())
		{
			LoggerGenerator.write(LoggerGenerator.EVENT_ACESSO_BD,
